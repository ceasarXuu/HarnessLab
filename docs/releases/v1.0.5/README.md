...
| 领域类型治理 | Stage 2 已完成 | 生产 UI 类型来自 `domain` / `api`；`app`、`screens`、`ui/components` 不再导入 mock fixture |
...
| 联调门禁 | Stage 2 已完成 | 已通过 typecheck、45 个 unit、lint、build、Storybook smoke、10 个 desktop/mobile e2e；Stage 3 还需真实 contract smoke |
