...
| API contract client | 部分完成 | 已有契约类型、HTTP/mock client、runtime mode、Jobs/Datasets hooks 与 DTO/ViewModel；Agents、Environments、Leaderboard、System、详情附属资源和 Operation 状态流仍待迁移；不建设 legacy adapter |
