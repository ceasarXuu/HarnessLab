...
- Dataset detail：点击 dataset 列表行后从右侧 drawer 滑出，默认展示 task 数、source、本地路径、大小、registry 与 task 列表；下载/拉取更新/删除本地数据按状态展示。digest/ref/split/manifest 命令等底层或运行上下文字段不默认展示。
