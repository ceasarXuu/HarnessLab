...
concurrency、attempts、debug、yes、env_file。task split、include/exclude 和 task limit 进入 Tasks tab。
...
3. JobConfig 单页多 tab 表单：基础、Tasks、Environment、Verifier、Runtime、Hub/Artifacts、Preview。
4. Run / Resume。
