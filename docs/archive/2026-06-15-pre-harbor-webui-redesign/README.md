...
|---|---|---|
| `docs/archive/stubs/prd.md` | `prd.md` | CLI-first product direction |
...
| `docs/archive/stubs/mvp-development-spec.md` | `mvp-development-spec.md` | Rust runtime MVP execution spec |
| `docs/archive/stubs/architecture.md` | `architecture.md` | Self-owned run orchestrator architecture |
| `docs/architecture/technology-decisions.md` | `technology-decisions.md` | Rust single-binary technology decision |
| `docs/archive/stubs/adapter-protocol.md` | `adapter-protocol.md` | Self-owned benchmark adapter/runtime protocol |
| `docs/archive/stubs/agent-registration-guide.md` | `agent-registration-guide.md` | CLI-first AgentProfile v1 registration flow |
| `docs/archive/stubs/agent-profile-reference.md` | `agent-profile-reference.md` | CLI-first AgentProfile v1 schema reference |
| `docs/playbooks/development-operations.md` | `development-operations.md` | Rust CLI operation notes |
| `docs/architecture/test-engineering.md` | `test-engineering.md` | Rust/Cargo test-engineering system |
...
The repository root `README.md` and `docs/architecture/docs-index.md` also point readers to the
