...
- Related Links:
  ...
  - `docs/archive/stubs/adapter-protocol.md`
...
| 0.6 | 2026-06-08 | Started Phase 1 protocol specification with `docs/archive/stubs/adapter-protocol.md` and registered `ADAPT-PROTOCOL-001..012` as planned requirement/test/selector gates. |
