...
const { ensureSource, sourceReady } = require("./source");
...
async function handleUpdate(args = []) {
  ...
  console.log("    4. Verify Harbor + OrnnLab imports");
  console.log("    5. Leave frontend pending v1.0.5 official-architecture rebuild");
  console.log("");
