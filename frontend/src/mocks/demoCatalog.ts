...
export const agentRows: AgentRow[] = [
  {
    ...
    mcp: '[{"enabled":true,"name":"terminal-bench-mcp","transport":"streamable-http","url":"http://mcp-server:8000/mcp"}]',
  ...
  },
  {
    ...
    mcp: '[{"enabled":true,"name":"swe-tools","transport":"sse","url":"http://swe-tools:8001/sse"}]',
    runtime: 'docker / 3600s',
    setupTimeout: '600s',
    maxTimeout: '7200s',
  ...
  },
  {
    ...
    mcp: '[{"enabled":true,"name":"local-repair-tools","transport":"stdio","command":"uvx","args":["local-repair-mcp"],"env":"LOCAL_MODEL_URL=${LOCAL_MODEL_URL}"}]',
