...
export const agentRows: AgentRow[] = [
  {
    ...
    mcp: '[{"enabled":true,"name":"terminal-bench-mcp","deployment":"compose-sidecar","serviceName":"terminal-bench-mcp","transport":"streamable-http","port":"8000","endpointPath":"/mcp","url":"http://terminal-bench-mcp:8000/mcp","composeYaml":"services:\\n  terminal-bench-mcp:\\n    image: terminal-bench-mcp:latest\\n    expose:\\n      - \\"8000\\""}]',
  ...
  },
  {
    ...
    mcp: '[{"enabled":true,"name":"swe-tools","deployment":"compose-sidecar","serviceName":"swe-tools","transport":"sse","port":"8001","endpointPath":"/sse","url":"http://swe-tools:8001/sse","composeYaml":"services:\\n  swe-tools:\\n    image: swe-tools-mcp:latest\\n    expose:\\n      - \\"8001\\""}]',
    runtime: 'docker / 3600s',
    setupTimeout: '600s',
    maxTimeout: '7200s',
  ...
  },
  {
    ...
    mcp: '[{"enabled":true,"name":"local-repair-tools","deployment":"stdio","transport":"stdio","command":"uvx","args":["local-repair-mcp"],"env":"LOCAL_MODEL_URL=${LOCAL_MODEL_URL}"}]',
