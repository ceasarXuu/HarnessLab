...
export const agentRows: AgentRow[] = [
  {
    ...
    adapter: 'none',
    modelPricing: [
      { modelName: 'claude-haiku-4-5', source: 'reported' },
      { modelName: 'claude-sonnet-4-5', source: 'reported' },
    ],
  ...
  },
  {
    ...
    adapter: 'none',
    modelPricing: [
      { modelName: 'gpt-5.1-codex', source: 'litellm' },
      { modelName: 'gpt-5.1-codex-mini', source: 'litellm' },
    ],
  ...
  },
  {
    ...
    modelPricing: [{
      modelName: 'qwen3-coder-local', source: 'custom',
      inputCacheMissUsdPerMillion: 0.4, inputCacheHitUsdPerMillion: 0.04,
