...
export const jobs: HarborJob[] = [
  ...
  },
  {
    ...
    includeInLeaderboard: true,
    jobDir: 'jobs/swe-bench-lite-claude',
    eventLogPath: '/Users/xuzhang/.ornnlab/HarnessLab/jobs/swe-bench-lite-claude/job.log',
    artifactPaths: [
      '/Users/xuzhang/.ornnlab/HarnessLab/jobs/swe-bench-lite-claude/harbor.config.json',
      '/Users/xuzhang/.ornnlab/HarnessLab/jobs/swe-bench-lite-claude/result.json',
      '/Users/xuzhang/.ornnlab/HarnessLab/jobs/swe-bench-lite-claude/job.log',
