...
export const jobs: HarborJob[] = [
  ...
  },
  {
    ...
    model: 'gpt-5.1',
    environment: 'docker',
    trial: { completed: 500, errored: 0, notPassed: 65, passed: 435, total: 500 },
    trials: '500 / 500',
    score: '87/100',
    cost: '$92.18',
    tokens: '1.8M',
    tokenUsage: '1.8M',
    runtimeSeconds: 12044,
  ...
  },
  {
    ...
    model: 'gpt-5.1',
    environment: 'docker',
    trial: { completed: 64, errored: 0, notPassed: 9, passed: 55, total: 64 },
    trials: '64 / 64',
    score: '68%',
    cost: '$15.90',
    tokens: '21.0k',
  ...
  },
  {
    ...
    environment: 'docker',
    trial: { completed: 500, errored: 0, notPassed: 45, passed: 455, total: 500 },
    trials: '500 / 500',
    score: '39%',
    cost: '$104.20',
    tokens: '2.1M',
    tokenUsage: '2.1M',
    runtimeSeconds: 13502,
  ...
  },
  {
    ...
    model: 'local-sim',
    environment: 'docker',
    trial: { completed: 8, errored: 0, notPassed: 0, passed: 8, total: 8 },
    trials: '8 / 8',
    score: '100%',
    cost: '$0.00',
    tokens: '0',
  ...
  },
  {
    ...
    model: 'claude-sonnet-4-5',
    environment: 'docker',
    trial: { completed: 2, errored: 1, notPassed: 1, passed: 1, total: 8 },
    trials: '3 / 8',
    score: '-',
    cost: '$0.63',
    tokens: '3.2k',
  ...
  },
  {
    ...
    model: 'local-sim',
    environment: 'docker',
    trial: { completed: 0, errored: 0, notPassed: 0, passed: 0, total: 128 },
    trials: '0 / 128',
    score: '-',
    cost: '$0.00',
    tokens: '-',
...
export const trialRows: TrialRow[] = [
  ...
  },
  {
    ...
    task: 'hello-world',
    result: 'errored',
    error: 'NonZeroAgentExitCodeError: Command failed (exit 1)',
    score: '0.00',
    retries: 2,
    duration: '38s',
    cost: '$0.63',
