...
describe('Environment templates', () => {
  ...
  it('manages OrnnLab-local templates over Harbor config fields', () => {
    ...
    expect(within(editableEnvironmentDialog).getByLabelText('type')).toHaveAttribute('aria-haspopup', 'listbox')
    expect(within(editableEnvironmentDialog).getByLabelText('network_mode')).toHaveAttribute('aria-haspopup', 'listbox')
    expect(within(editableEnvironmentDialog).getByLabelText('os')).toHaveAttribute('aria-haspopup', 'listbox')
    expect(within(editableEnvironmentDialog).getByLabelText('force_build')).toHaveAttribute('type', 'checkbox')
    expect(within(editableEnvironmentDialog).getByLabelText('cpu_enforcement_policy')).toHaveAttribute('aria-haspopup', 'listbox')
    expect(within(editableEnvironmentDialog).getByLabelText('extra_allowed_hosts')).toBeInTheDocument()
    ...
    expect(within(editableEnvironmentDialog).getByText('env')).toBeInTheDocument()
