...
describe('Environment templates', () => {
  ...
  it('manages OrnnLab-local templates over Harbor config fields', () => {
    ...
    expect(within(editableEnvironmentDialog).getByRole('tab', { name: 'Environment' })).toBeInTheDocument()
    ...
    expect(within(editableEnvironmentDialog).getByLabelText('Allowed hosts')).toHaveValue('pypi.org, github.com, huggingface.co')
    fireEvent.click(within(editableEnvironmentDialog).getByRole('checkbox', { name: 'Network access' }))
    expect(within(editableEnvironmentDialog).queryByLabelText('Allowed hosts')).not.toBeInTheDocument()
    fireEvent.click(within(editableEnvironmentDialog).getByRole('checkbox', { name: 'Network access' }))
    expect(within(editableEnvironmentDialog).getByLabelText('Allowed hosts')).toHaveValue('*')
    fireEvent.click(within(editableEnvironmentDialog).getByRole('tab', { name: 'Environment' }))
    ...
    fireEvent.click(within(environmentDialog).getByRole('tab', { name: 'Environment' }))
