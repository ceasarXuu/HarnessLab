...
describe('App', () => {
  ...
  it('adds a queued job from the dedicated new run flow', () => {
    ...
    expect(screen.queryByLabelText('Include tasks')).not.toBeInTheDocument()
    ...
    expect(screen.getByLabelText('Task range')).toHaveTextContent('Run all tasks')
    expect(screen.queryByLabelText('Include tasks')).not.toBeInTheDocument()
    fireEvent.click(screen.getByLabelText('Task range'))
    fireEvent.click(screen.getByRole('option', { name: 'Custom range' }))
    expect(screen.getByLabelText('Include tasks')).toHaveValue('')
    expect(screen.getByLabelText('Exclude tasks')).toHaveValue('')
    expect(screen.getByLabelText('Task limit')).toHaveValue(64)
