...
describe('WebUiHttpClient', () => {
  ...
  it('maps every visible write to a WebUI contract route rather than a legacy route', async () => {
    ...
    expect(urls).toEqual(expect.arrayContaining([
      ...
      '/api/webui/v1/datasets/dataset%401/move',
      '/api/webui/v1/datasets/dataset%401/relocate',
      '/api/webui/v1/datasets/dataset%401/registration',
      '/api/webui/v1/agents',
      '/api/webui/v1/harnesses?limit=100',
